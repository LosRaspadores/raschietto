...
import json
from scrapingAutomatico import scraping_titolo, scraping_autore, scraping_doi, scraping_anno, scraping_citazioni, scraping_automatico_titolo
